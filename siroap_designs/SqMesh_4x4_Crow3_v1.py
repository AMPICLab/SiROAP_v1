...
kappa3       = kappa2 # Coupling coefficients            
kappa4       = kappa1  # Coupling coefficients            
phi1         = -6.04904 # Phase shifts in the rings
phi2         = -0.06557 # Phase shifts in the rings
phi3         = phi1 # Phase shifts in the rings
...
drop = sip.dB10(det[0,:,det_list.index('p11'),0])
